    ...
    <nav class="navbar  fixed-top">
        <div class="container">
            <a href="#" class="navbar-brand">
              <strong class="titulo-agregar">INMOBILIARIA - CAPITAL.</strong>
            </a>
            ...
            <div class="collapse navbar-collapse  d-md-none" id="menu-principal">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"> <a class="nav-link " href="../administracion/administracion.php">Usuarios Registrados</a> </li>
                    <li class="nav-item"> <a class="nav-link " href="agregar.html">Agregar Inmuebles</a> </li>
                    <li class="nav-item"> <a class="nav-link " href="../administracion/publicaciones.php">Ver todas las publicaciones</a> </li>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../administracion/administracion.php">
                                <span data-feather="home">Usuarios Registrados</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../administracion/agregar.html">
                                <span data-feather="file"></span>Agregar Inmuebles
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="../administracion/publicaciones.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom border-">
                    <h1 class="h2">Chat capital</h1>
                </div>
