                      ...
                      <div class="detallada">
                        ...
                        <hr class="separador">
                            ...
                            <select class="informacion select" multiple name="caracteristicas" id="caracteristicas" data-caracteristicas>
                                ...
                                <option class="opciones" >Balcón</option>
                                <option class="opciones" >Alquiler</option>
                                <option class="opciones" >Terraza</option>
                                <option class="opciones" >Amueblado</option>
                                <option class="opciones" >Piscina</option>
                                <option class="opciones" >Vista al mar</option>
                                </select>
                          ...
                          <div class="mas">
                            ...
                            <input class="inmueble" type="number" name="metros" id="metros" placeholder="Cantidad de metros del inmueble" required data-metros>
                       </div> 

                            <button type="submit" id="agregar" class="agregar-boton">Agregar</button>
                        </form>
                    </div>
